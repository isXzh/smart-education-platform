  ...
  <div class="device-management-page">
      ...
      <div class="table-container">
        ...
        <div class="pagination-wrapper">
          <div class="pagination-info">
            共 {{ filteredDevices.length }} 台设备，当前第 {{ currentPage }} /
            {{ totalPages }} 页
          </div>
          <el-pagination
      ...
      >
        <el-form-item label="设备名称" prop="name">
          <el-input
            ...
            placeholder="请输入设备名称，如：移动课堂箱-A01"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="SN码" prop="sn">
          <el-input
            ...
            placeholder="请输入设备SN码，如：SN202401001"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="设备状态" prop="status">
          ...
          >
            ...
            <el-option label="使用中" value="inuse">
              <span class="status-option">
                <span class="status-dot inuse"></span>使用中
              </span>
            </el-option>
            <el-option label="已过期" value="expired">
              <span class="status-option">
                <span class="status-dot expired"></span>已过期
              </span>
            </el-option>
          </el-select>
        </el-form-item>
    ...
    >
        ...
        <div class="info-row">
          ...
          <div class="info-item">
            ...
            <span class="info-value">{{
              logDialog.device.activationDate
            }}</span>
          </div>
          <div class="info-item">
      ...
      <div slot="footer" class="log-dialog-footer">
        ...
        <el-button type="primary" @click="logDialog.visible = false"
          >关闭</el-button
        >
      </div>
    </el-dialog>
...
export default {
    ...
    filteredDevices() {
      ...
      if (this.selectedNode) {
        result = result.filter((device) =>
          device.departmentId.startsWith(this.selectedNode.id)
        );
      }
      ...
      if (this.filters.status) {
        result = result.filter(
          (device) => device.status === this.filters.status
        );
      }
  ...
  methods: {
    ...
    batchDelete() {
      ...
      this.$confirm(
        `确定要删除选中的 ${this.selectedDevices.length} 台设备吗？`,
        "提示",
        {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
      ...
      this.$refs.deviceForm.validate((valid) => {
        if (valid) {
          if (this.deviceForm.id) {
            // 编辑
            const index = this.deviceData.findIndex(
