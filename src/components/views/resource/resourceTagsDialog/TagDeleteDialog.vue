<template>
  <el-dialog
    ...
    width="400px"
    @close="handleClose"
    custom-class="tag-delete-dialog"
    top="30vh"
  >
    <div class="flex items-center gap-4 mb-4">
      ...
      <div>
        <h3 class="text-lg font-semibold">确认删除标签</h3>
        <p class="text-sm text-gray-500">此操作不可恢复</p>
      </div>
    </div>
    <p class="text-sm text-gray-600 mb-6">确定要删除该标签吗？删除后无法恢复。</p>
...
<style>
.tag-delete-dialog .el-dialog__header {
  display:none;
}
</style>
