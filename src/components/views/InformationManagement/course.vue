    ...
    <div class="main-card">
      ...
      <div class="header-section">
        ...
        <div class="filter-section">
          ...
          <!-- 新增课程按钮 -->
          <el-button type="primary" class="add-course-btn" @click="handleAddCourse">
          ...
          <el-table-column label="操作" width="100" fixed="right">
            <template slot-scope="scope">
              <div class="operation-icons">
                <i class="el-icon-edit operation-icon" @click="handleEdit(scope.row)"></i>
                <i class="el-icon-delete operation-icon delete-icon" @click="handleDelete(scope.row)"></i>
              </div>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="pagination-container">
        <div class="pagination-left">
          显示 {{ (filterForm.pageNum - 1) * filterForm.pageSize + 1 }} -
          {{ Math.min(filterForm.pageNum * filterForm.pageSize, total) }} 条，共 {{ total }} 条
        </div>
        <el-pagination
          background
  ...
  export default {
    ...
    methods: {
      ...
      handleStageChange(stageId) {
        this.filterForm.subjectId = null;
