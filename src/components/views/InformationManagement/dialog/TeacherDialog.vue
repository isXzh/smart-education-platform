  ...
  >
    ...
    >
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          ...
          <el-form-item label="工号" prop="employeeNo">
            <el-input v-model="formData.employeeNo" placeholder="请输入工号" maxlength="20" />
          </el-form-item>
        </div>
        <div class="form-row">
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <el-form-item label="所属学段" prop="collegeId">
            <el-select v-model="formData.collegeId" placeholder="请选择学段">
          ...
          <el-form-item label="所属组织" prop="organizationId">
            <el-select v-model="formData.organizationId" placeholder="请选择组织">
              <el-option label="小学部" :value="1" />
              <el-option label="初中部" :value="2" />
              <el-option label="高中部" :value="3" />
            </el-select>
          </el-form-item>
        </div>
      </div>
