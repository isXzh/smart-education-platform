<template>
  <el-dialog
    ...
    custom-class="class-import-dialog"
    @close="handleClose"
  >
    <div class="import-content">
      ...
      <div class="import-notice">
        ...
        <ul class="notice-list">
          ...
          <li>2. 模板包含：班级名称、所属学段、所属年级、班主任、教室、排序、状态、备注</li>
          <li>3. 班级名称在同一学段同一年级下不可重复</li>
          <li>4. 所属学段和年级必须在系统中已存在</li>
          <li>5. 状态填写"启用"或"禁用"</li>
        </ul>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      async handleDownloadTemplate() {
        try {
          const response = await classApi.downloadTemplate();
      ...
      async handleImport() {
        ...
        try {
          ...
          await classApi.import(formData);
