        ...
        <div class="filter-section">
          <el-dropdown trigger="click" @command="handleFilterChange">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="全部负责人"
                >全部负责人</el-dropdown-item
              >
            ...
            <template #default="{ node, data }">
              ...
              >
                ...
                <el-dropdown
                  ...
                  @visible-change="
                    (show) => handleDropdownVisible(show, data.id)
                  "
                >
                  <span
                    class="more-btn"
        ...
        <template v-if="currentOrg">
          ...
          <div class="info-card">
            <div class="card-header">
              <div
                class="org-icon-large"
                :class="getIconBgClass(currentOrg.orgType)"
              >
              ...
              <div class="org-title">
                <div class="org-name">
                  {{ currentOrg.orgName }}
                  <el-tag
                    v-if="currentOrg.type"
                    size="small"
                    class="type-tag"
                    :type="getTagType(currentOrg.orgType)"
                  >
              ...
              <div class="header-actions">
                <el-button
                  size="small"
                  class="edit-btn"
                  @click="handleEditOrg(currentOrg)"
                >
                  <i class="el-icon-edit"></i>
                  编辑
                </el-button>
                <el-button
                  ...
                  size="small"
                  class="add-sub-btn"
                  @click="handleAddSubOrg(currentOrg)"
                >
                  <i class="el-icon-user"></i>
                  添加下级
                </el-button>
                ...
                <el-table-column label="组织名称" min-width="200">
                  <template #default="{ row }">
                    <div class="table-org-name">
                      <div
                        class="table-icon"
                        :class="getIconBgClass(row.orgType)"
                      >
