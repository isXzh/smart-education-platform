<template>
  ...
  >
    ...
    <!-- 表单内容 -->
    <div class="dialog-body" v-loading="loading" element-loading-text="加载中...">
      <el-form ref="form" :model="form" :rules="rules" label-position="top">
        ...
        <el-form-item label="负责人">
          <el-input v-model="form.leader" placeholder="请输入负责人姓名" class="form-input" />
        </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button class="confirm-btn" type="primary" @click="handleConfirm">添加</el-button>
    </div>
  </el-dialog>
</template>
    ...
    methods: {
      ...
      handleConfirm() {
        this.$refs.form.validate(valid => {
          if (valid) {
            let params = {
              parentId: this.form.parentId ? this.form.parentId : this.currentOrg.id,
