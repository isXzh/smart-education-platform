...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      // 基础信息管理-年级管理
      {
        path: 'Information-subject-grades',
        name: 'Information-subject-grades',
        component: Grades,
      },
      // 基础信息管理-人员管理
      {
        path: 'Information-subject-personnel',
        name: 'Information-subject-personnel',
        component: Personnel,
      },
      // 基础信息管理-课程管理
      {
...
router.beforeEach((to, _from, next) => {
  // 显示页面标题
  document.title = to.meta.title ? `${to.meta.title} - 智慧教育云平台` : '智慧教育云平台';
